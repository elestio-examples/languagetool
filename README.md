...
# Once deployed ...
    ...
    Go to the LangagueTool website and choose the app or Add-on of your choice.
    In our case, we will choose Chrome

<img src="step-01.png" style='width: 30%;'/>

    Step 2.

    In google chrome, go to the extensions tab and choose Grammar & Spell Checker.

<img src="step-02.png" style='width: 30%;'/>
<img src="step-03.png" style='width: 30%;'/>

    Step 3.

    Click on the cog wheel at the bottom right of the tab

<img src="step-04.png" style='width: 30%;'/>

    Step 4.

    Go to the very bottom of the page and choose Advanced settings

<img src="step-05.png" style='width: 30%;'/>
...
<img src="step-06.png" style='width: 30%;'/>

    That's all. Now you can go in Gmail for example, and type a mail.
    LanguageTool will do the job!

<img src="step-07.png" style='width: 30%;'/>
<img src="step-08.png" style='width: 30%;'/>
